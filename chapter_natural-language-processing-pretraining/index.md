...
![Az előtanított szövegreprezentációk különböző mélytanulás architektúrákba táplálhatók be, különböző downstream természetes nyelvfeldolgozási alkalmazásokhoz. Ez a fejezet az upstream szövegreprezentáció előtanítására összpontosít.](../img/nlp-map-pretrain.svg)
:label:`fig_nlp-map-pretrain`


A nagy kép áttekintéséhez
az :numref:`fig_nlp-map-pretrain` ábra megmutatja,
hogy az előtanított szövegreprezentációk számos különböző mélytanulás architektúrába táplálhatók be
