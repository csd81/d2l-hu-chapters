...
def show_bboxes(axes, bboxes, labels=None, colors=None):
    """Befoglaló téglalapok megjelenítése."""
...
def box_iou(boxes1, boxes2):
    """Két befoglaló téglalapok listájának páronkénti IoU-ja."""
...
def assign_anchor_to_bbox(ground_truth, anchors, device, iou_threshold=0.5):
    """A legszorosabban illeszkedő referencia-befoglaló téglalapok hozzárendelése a horgonytéglalapokhoz."""
...
def offset_boxes(anchors, assigned_bb, eps=1e-6):
    """Horgonytéglalap-eltolások transzformációja."""
...
def multibox_target(anchors, labels):
    """Horgonytéglalapok felcímkézése referencia-befoglaló téglalapok alapján."""
...
def offset_inverse(anchors, offset_preds):
    """Befoglaló téglalapok előrejelzése horgonytéglalapok és előrejelzett eltolások alapján."""
...
def nms(boxes, scores, iou_threshold):
    """Előrejelzett befoglaló téglalapok megbízhatósági pontszámainak rendezése."""
    B = scores.argsort()[::-1]
...
def multibox_detection(cls_probs, offset_preds, anchors, nms_threshold=0.5,
    ...
    """Befoglaló téglalapok előrejelzése nemmaximális elnyomással."""
