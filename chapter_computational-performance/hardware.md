...
A legtöbb mélytanulás kutató és szakember hozzáfér egy számítógéphez, amely megfelelő mennyiségű memóriával, számítási kapacitással és valamilyen gyorsítóval (például GPU-val) rendelkezik, esetleg több ilyen eszközzel. Egy számítógép a következő fő összetevőkből áll:
...
Az egyik véglet a WiFi, amely meglehetősen jó hatótávolsággal rendelkezik, nagyon könnyen használható (nincsenek kábelek), olcsó, de viszonylag gyenge sávszélességet és késleltetést kínál. Egyetlen ésszerűen gondolkodó gépi tanulás kutató sem használná szerverfürtök építéséhez. A továbbiakban azokra az összeköttetésekre összpontosítunk, amelyek alkalmasak a mélytanulásra.
