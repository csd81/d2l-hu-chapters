# A `d2l` API dokumentáció
:label:`sec_d2l`

Ez a szakasz ábécérendben sorolja fel a `d2l` csomag osztályait és függvényeit, megmutatva, hol szerepelnek a könyvben, hogy megtalálhasd a részletesebb megvalósításokat és magyarázatokat.
A forráskód a [GitHub-tárolóban](https://github.com/d2l-ai/d2l-en/tree/master/d2l) is elérhető.
