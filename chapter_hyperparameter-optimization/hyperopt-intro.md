...
A *hiperparaméter-optimalizáló (HPO)* algoritmusok célja, hogy elvszerű és automatizált módon kezeljék ezt a problémát :cite:`feurer-automlbook18a`, globális optimalizálási feladatként fogalmazva meg azt. Az alapértelmezett célkitűzés a félretett validációs halmazon mért hiba, de elvben bármilyen más üzleti metrika is lehet. Kombinálható vagy korlátozható másodlagos célkitűzésekkel, mint például a tanítási idő, az inferencia ideje vagy a modell összetettsége.
