...
Az alábbi kódban (**implementáljuk a pooling réteg előre-terjedését**) a `pool2d` függvényben. Ez a függvény hasonló a `corr2d` függvényhez a :numref:`sec_conv_layer`-ben. Azonban nem szükséges kernel, a kimenetet a bemenet minden régiójának maximumaként vagy átlagaként számítjuk.
