...
Csupán némi zaj képes kilökni a paramétert a lokális minimumból. Ez egyébként a minibatch sztochasztikus gradient descent egyik előnyös tulajdonsága: a gradiensek természetes variabilitása a minibatchek között képes kiszabadítani a paramétereket a lokális minimumokból.
